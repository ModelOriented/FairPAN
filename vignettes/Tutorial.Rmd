...
`FairPAN` is a tool not only for creating fair predictive adversarial networks,
...
worsening of the performance is really small.
...
especially convenient in the process of parameters tuning and model adjustions,
...
As fairness is recall close with XAI, we also propose an option to create an
