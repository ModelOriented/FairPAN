test_that("test-plot_that", {
  ...
  # plot_monitor(monitor1$STP,monitor1$adversary_acc,monitor1$classifier_acc,
  #              monitor1$adversary_losses)
  plot1 <- plot_monitor(monitor2$STP,monitor2$adversary_acc,monitor2$classifier_acc,
               monitor2$adversary_losses)
  plot2 <- plot_monitor(monitor3$STP,monitor3$adversary_acc,monitor3$classifier_acc,
               monitor3$adversary_losses)
  ...
  exp <- Single_explainer(processed$test_y,model1,"classifier",processed$data_test,processed$data_scaled_test,
