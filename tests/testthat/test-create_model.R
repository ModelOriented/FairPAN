test_that("test-create_model", {
  ...
  model <- create_model(train_x,train_y,neurons=c(16,8,16),dimensions = 1)

  model2 <- create_model(train_x,train_y,neurons=c(16,8,16),dimensions = 1)

  model3 <- create_model(train_x,train_y,neurons=c(16,16,16),dimensions = 1)
  #tests for seed
