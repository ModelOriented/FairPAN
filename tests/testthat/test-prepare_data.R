test_that("test-prepare_data", {
  ...
  expect_true(torch_equal(dsl$train_ds$y,torch_tensor(train_y,dtype = torch_long())))
  expect_true(torch_equal(dsl$test_ds$y,torch_tensor(test_y,dtype = torch_long())))
  ...
  expect_true(torch_equal(dsl$train_dl$dataset$y,torch_tensor(train_y,dtype = torch_long())))
  expect_true(torch_equal(dsl$test_dl$dataset$y,torch_tensor(test_y,dtype = torch_long())))
